			...
			<div class="card widget-1">
			  <div class="card-body"> 
				<div class="widget-content">
				  ...
				  <div> 
					  <h4>4,200</h4><span class="f-light">Relation Request</span>
					</div>
				</div>
			...
			<div class="card widget-1">
				<div class="card-body"> 
					<div class="widget-content">
						...
						<div> 
						<h4>{{$admin_data['tuser']}}</h4><span class="f-light">Total Users</span>
					</div>
				  </div>
			...
			<div class="card widget-1">
			  <div class="card-body"> 
				<div class="widget-content">
				  ...
				  <div> 
					<h4 class="mb-1">1,80k</h4><span class="f-light">Update Profile Request</span>
				  </div>
				</div>
			  ...
			  <div class="card widget-1">
				<div class="card-body"> 
				  <div class="widget-content">
					...
					<div> 
						<h4>{{$admin_data['trelation']}}</h4><span class="f-light">Total Relations </span>
					</div>
				  </div>
		...
		<div class="row"> 
		  <div class="col-xxl-12 col-xl-6 box-col-12">
			<div class="card widget-1 widget-with-chart">
			  <div class="card-body"> 
				<div> 
				  <h4 class="mb-1">1,80k</h4><span class="f-light">Pending Request</span>
				</div>
		  ...
		  <div class="col-xxl-12 col-xl-6 box-col-12">
			<div class="card widget-1 widget-with-chart">
			  <div class="card-body"> 
				<div> 
				  <h4 class="mb-1">6,90k</h4><span class="f-light">Active Users</span>
				</div>
