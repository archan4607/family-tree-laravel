<div class="sidebar-wrapper" sidebar-layout="stroke-svg">
    <div>
        <div class="logo-wrapper"><a href="{{ route('index') }}"><img class="img-fluid for-light" height="50" width="50"
                    src="{{ asset('assets/images/logo/logo.png') }}" alt=""> FAMILY TREE<img class="img-fluid for-dark"
                ...
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    @if (session()->has('user'))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('user') }}">
                                <svg class="stroke-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-home') }}"></use>
                                </svg>
                                <svg class="fill-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#fill-home') }}"> </use>
                                </svg><span>Dashboard [USER]</span>
                            </a>
                        </li>
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('view-profile') }}">
                                <svg class="stroke-icon">
                        ...
                        @if ($data->user_status == 0)
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    href="{{ route('register_user_page') }}">
                                    <svg class="stroke-icon">
                                        <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-task') }}"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ asset('assets/svg/icon-sprite.svg#fill-task') }}"> </use>
                                    </svg><span>Register Page</span>
                                </a>
                            </li>
                        @endif
                        @if ($data->user_status == 1)
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i></i><a
                                    class="sidebar-link sidebar-title link-nav" href="{{ route('add-relations') }}">
                                    <svg class="stroke-icon">
                                        <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-learning') }}"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ asset('assets/svg/icon-sprite.svg#fill-learning') }}"> </use>
                                    </svg><span>Add Relations</span>
                                </a>
                            </li>
                        @endif
                        @if ($data->user_status == 2)
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i></i><a
                                    class="sidebar-link sidebar-title link-nav"
                                    href="{{ route('user-view-relations') }}">
                                    <svg class="stroke-icon">
                                        <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-learning') }}"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ asset('assets/svg/icon-sprite.svg#fill-learning') }}"> </use>
                                    </svg><span>View Relations</span>
                                </a>
                            </li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="{{ route('find-relation') }}">
                                    <svg class="stroke-icon">
                                        <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-search') }}"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ asset('assets/svg/icon-sprite.svg#fill-search') }}"> </use>
                                    </svg><span>Find Relation</span></a>
                            </li>
                        @endif
                    @endif
                    @if (session()->has('admin'))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('admin') }}">
                                <svg class="stroke-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-home') }}"></use>
                                </svg>
                                <svg class="fill-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#fill-home') }}"> </use>
                                </svg><span>Dashboard [ADMIN]</span>
                            </a>
                        </li>
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('admin-profile') }}">
                                <svg class="stroke-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-task') }}"></use>
                                </svg>
                                <svg class="fill-icon">
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('manage_user') }}">
                                <svg class="stroke-icon">
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('view-relations') }}">
                                <svg class="stroke-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-learning') }}"></use>
                                </svg>
                                <svg class="fill-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#fill-learning') }}"> </use>
                                </svg><span>Relations</span>
                            </a>
                        </li>
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('manage_request') }}">
                                <svg class="stroke-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-user') }}"></use>
                                </svg>
                                <svg class="fill-icon">
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('find-relation-admin') }}">
                                <svg class="stroke-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-search') }}"></use>
                                </svg>
                                <svg class="fill-icon">
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                            ...
                            <svg class="fill-icon">
                                <use href="{{ asset('assets/svg/icon-sprite.svg#bin') }}"></use>
                            </svg><span>Trash</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('general-widget') }}">User</a></li>
                            <li><a href="{{ route('chart-widget') }}">Relation</a></li>
                        </ul>
                    </li>
                    @endif
                    <>
