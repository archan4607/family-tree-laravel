...
// AUTH ROUTES START
// Route::get('/register', [Auth::class,'register_form']);
Route::post('/register', [AuthCtrl::class,'insert_regdata']);
Route::post('/login', [AuthCtrl::class,'login'])->name("loginpage");
Route::get('/logout', [AuthCtrl::class,'logout'])->name("logout");
Route::get('/register', function () {
    return view('user/register');
})->withoutMiddleware('logincheck')->name('register');

Route::get('/login', function () {
    return view('user/login');
})->withoutMiddleware('logincheck')->name('loginnew');
// AUTH ROUTES END
...
Route::middleware(['logincheck'])->group(function () {
    Route::get('/', [AuthCtrl::class,'redirect_check'])->name('user');
    Route::get('/detail-register', [UserCtrl::class,'get_data'])->name("register_user_page");
    Route::post('/detail-register', [UserCtrl::class,'detail_register'])->name("detail_register");
    Route::get('/view-profile',[UserCtrl::class,'user_profile'])->name('view-profile');
    Route::get('/edit-profile',[UserCtrl::class,'view_user_profile'])->name('edit-user-profile');
    Route::get('/add-relations', [UserCtrl::class,'relations_check'])->name('add-relations');
    Route::get('/add-relation', function(){
        return view('user.add-relations');
    })->name('add-relation');
    Route::post('/add-relations',[UserCtrl::class,'add_relations'])->name('insert_relations');
    Route::post('/request-relation',[UserCtrl::class,'request_relations'])->name('request_relations');
    Route::get('/view-relations',[UserCtrl::class,'view_relation'])->name('user-view-relations');
    Route::post('/confirm-relations',[UserCtrl::class,'confirm_relation'])->name('confirm-relations');
    Route::post('/reject-relation',[UserCtrl::class,'reject_relation'])->name('reject-relation');
    Route::get('/find-relation',function(){
        return view('user.find-relation');
    })->name('find-relation');
    Route::post('/find-relation',[UserCtrl::class,'find_relations'])->name('find-relation');
    Route::get('/add-modal-relation',[UserCtrl::class,'add_modal_relation'])->name('add-modal-relation');
    
    // Route::get('/ajax-test',function(){
    //     return view('user.ajax-test');
    // })->name('ajax-test');
    // Route::post('/ajax-test',[UserCtrl::class,'number_check'])->name('number-check');
...
Route::prefix('admin')->middleware(['logincheck'])->group(function () {
    // Route::get('/', [AuthCtrl::class,'redirect_check'])->name('admin');
    Route::get('/', [AdminCtrl::class,'admin_dashboard'])->name('admin');
    Route::get('/view-admin-profile',[AdminCtrl::class,'view_admin_profile'])->name('view-admin-profile');
    Route::get('/manage-user', [AdminCtrl::class,'manage_user'])->name('manage_user');
    Route::get('/profile',[AdminCtrl::class,'admin_profile'])->name('admin-profile');
    Route::get('/manage-request', [AdminCtrl::class,'manage_request'])->name('manage_request');
    Route::get('/manage-user/{id}',[AdminCtrl::class,'view_user_profile'])->name('view-user-profile');
    Route::get('/manage-request/{id}/{true?}',[AdminCtrl::class,'approved_user'])->name('verify_user');  
    Route::get('/view-relations',[AdminCtrl::class,'view_relations'])->name('view-relations');
    Route::get('/delete-user/{id}',[AdminCtrl::class,'delete_user'])->name('delete-user');
    Route::get('/delete-relation/{id}',[AdminCtrl::class,'delete_relation'])->name('delete-relation');
    Route::get('/find-relation',function(){
        return view('user.find-relation');
    })->name('find-relation-admin');
    Route::post('/find-relation',[AdminCtrl::class,'find_relations'])->name('find-relation-admin');

    // Route::post('/manage-request/{id}/false',[AdminCtrl::class,'reject_user'])->name('verify_user');
});
